...
This standard prevents inconsistent terminology across websites, social media accounts, policy documents, correspondence and stakeholder engagement materials. Inconsistent naming creates confusion about who the policy author is, what the reform proposal is, what RRC means, and what role Dan Sonsie and Sonsie Carpentry play.

All public-facing and externally distributed materials produced by or on behalf of Carpenters for Housing Reform Victoria must follow this standard.

---

## 2. Controlled Identities

### 2.1 Carpenters for Housing Reform Victoria

| Field | Value |
|---|---|
| Official name | Carpenters for Housing Reform Victoria |
| Approved abbreviation | CFHRV (use sparingly; prefer the full name) |
| Role | Policy author and reform organisation |
...
| Field | Value |
|---|---|
| Official name | RRC Pathway Reform |
| Approved abbreviation | None — write out in full |
| Role | The reform proposal seeking a clear, bounded recognition pathway for experienced residential carpenters |
...
| Field | Value |
|---|---|
| Official name | Dan Sonsie |
| Approved abbreviation | None |
| Role | Founder of Carpenters for Housing Reform Victoria; evidence custodian for the RRC pathway proposal |
...
| Field | Value |
|---|---|
| Official name | Sonsie Carpentry Pty Ltd |
| Approved abbreviation | Sonsie Carpentry |
| Role | Dan Sonsie's separate operating carpentry business |
| Approved short description | Dan Sonsie's residential renovation carpentry business, operating separately from the Carpenters for Housing Reform Victoria reform initiative. |
| Must not be confused with | The policy author or owner of the reform initiative. Sonsie Carpentry is not the proponent or author of the RRC pathway proposal. |

---

## 3. Mandatory Terminology

The following rules apply to all public-facing and externally distributed materials:

- **"RRC" means "Registered Residential Carpenter."** No other expansion is permitted.
...
Carpenters for Housing Reform Victoria is an industry-led reform initiative proposing a clear, bounded recognition pathway for experienced Victorian residential renovation carpenters, focused on renovation responsibility, consumer protection and regulatory clarity.

### C. Social Media Bio (maximum 150 characters)

> Advocating for a clear, evidence-based pathway for experienced Victorian residential carpenters. Reform • Recognition • Consumer protection

*Character count: 137. Do not add hashtags, handles or promotional language without reviewing against the mandatory terminology rules.*

### D. Dan Sonsie Biography (approximately 50–80 words)

Dan Sonsie is a Victorian residential renovation carpenter with approximately 20 years of practical experience. He is the founder of Carpenters for Housing Reform Victoria and the evidence custodian for the Registered Residential Carpenter (RRC) pathway proposal. His renovation practice spans structural framing repairs, concealed-condition work, bathroom and kitchen renovations, and trade coordination. He is director of Sonsie Carpentry Pty Ltd, a separate operating carpentry business.

### E. RRC Pathway Description (approximately 40–70 words)

The Registered Residential Carpenter (RRC) pathway is a proposed bounded recognition category for experienced Victorian residential renovation carpenters. It defines included and excluded work, requires mandatory handoff triggers to registered builders, engineers and building surveyors, and is designed to make the renovation responsibility boundary visible, lawful and enforceable. The pathway is a reform proposal under consultation. It is not currently a government-approved registration category.

---

## 5. Logo Wording Standard

The approved logo hierarchy is:

| Element | Wording |
|---|---|
| Large letters | RRC |
| Main wording | Registered Residential Carpenter |
| Secondary wording | Pathway Reform |
| Footer | Carpenters for Housing Reform Victoria |

**"Residential Carpenter Reform" must not appear as the expansion of RRC or as any part of the logo, header or descriptor.** The only approved expansion of RRC is "Registered Residential Carpenter."

If logo artwork, PDFs or printed materials use any other expansion of RRC, those materials must be reviewed and corrected before further distribution.
...
| Carpenters for Housing Reform Victoria | Sonsie Carpentry Reform Initiative |
| RRC Pathway Reform | Residential Carpenter Reform |
...
| Registered Residential Carpenter (RRC) pathway | RRC (Residential Carpenter Reform) pathway |
...
| We are seeking government examination of the proposed RRC pathway. | The Victorian Government has engaged with our proposal. |
...
| The initiative does not claim government endorsement. | This is a government-supported initiative. |
...
| Dan Sonsie is the evidence custodian for the RRC pathway proposal. | Dan Sonsie is an approved industry representative. |
| Dan Sonsie is a Victorian renovation carpenter with ~20 years of practical experience. | Dan Sonsie is a registered builder. |
...
- **Document custodian:** Dan Sonsie
- Changes to any controlled terminology in this document require deliberate review and a record in `DECISION_REGISTER.md` (when established).
- All public materials must be reviewed against this standard before release.
- Public materials must not imply statutory approval, government endorsement or regulatory authority unless formal written confirmation has been received from the relevant government body and is documented in the stakeholder claims register.
- Sonsie Carpentry must not be presented as a policy author in any public material.
- If any logo, PDF, printed material or digital asset is found to use an incorrect expansion of RRC, it must be reviewed and corrected before further distribution.

---

*Carpenters for Housing Reform Victoria — Brand and Identity Standard v1.0, August 2026.*
