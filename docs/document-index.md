...
| Document | Location | Status | Purpose | Last Reviewed |
|---|---|---|---|---|
| **Functional Distinctiveness Evidence Baseline v0.1** | `docs/evidence-analysis/functional-distinctiveness-evidence-baseline-v0.1.md` | **WORKING DRAFT** | **Governed primary-source evidence review. Tests whether advanced residential renovation carpentry involves a recurring and materially distinct practitioner function separable from ordinary carpentry, builder responsibility, DB-L Carpentry, engineering, surveying and licensed-trade functions. Parts 1–22. Eight comparator groups. Final classification: C — DISTINCT_FUNCTION_IS_PLAUSIBLE_BUT_NOT_SUFFICIENTLY_EVIDENCED, 50%. ARC C updated to 50%; Harm B/55% and Population B/65% unchanged. DB-L retained as primary alternative explanation. Not an ARC advocacy document. Stop for Dan and Atlas review.** | August 2026 |
